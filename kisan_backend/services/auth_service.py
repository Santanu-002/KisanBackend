...
class AuthService:
    ...
    async def verify_otp(self, phone_number: str, otp: str, clear_state: bool = True) -> Tuple[User, bool]:
        ...
        # Reject unknown phone numbers — they have no account at all.
        # Role-based access control is enforced at the endpoint layer,
        # where the request channel (browser vs. native app) is available.
        if not user:
